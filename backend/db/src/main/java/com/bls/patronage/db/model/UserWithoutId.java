...
public class UserWithoutId extends IdentifiableEntity {
    private String email;
    private String name;

    public UserWithoutId(String id, String email, String name) {
        super(id);
        this.email = email;
        this.name = name;
    }

    public UserWithoutId(UUID id, String email, String name) {
        super(id);
        this.email = email;
        this.name = name;
    }
